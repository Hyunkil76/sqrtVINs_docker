...
CONFIG=grand_tour
BAG="/dataset/grand_tour/group_7"
RESULT_ROOT="/result/mono"

# Common launch options
MAX_CAMERAS=1
USE_STEREO=false
BAG_STARTS=(0.0 0.0 0.0 0.0) 

# Per-dataset options
HISTOGRAM_METHODS=(CLAHE CLAHE CLAHE CLAHE )  # [HISTOGRAM or CLAHE]
INIT_DYN_USES=(false false false true)
