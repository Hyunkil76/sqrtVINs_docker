CONFIG=grand_tour
BAG="/dataset/grand_tour/group_2"
RESULT_ROOT="/result"
...
# Per-dataset options
HISTOGRAM_METHODS=(HISTOGRAM CLAHE HISTOGRAM CLAHE HISTOGRAM)  # [HISTOGRAM or CLAHE]
INIT_DYN_USES=(true false false false false)
