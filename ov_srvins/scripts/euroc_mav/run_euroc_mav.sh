...
PARAM_FILE="${SCRIPT_DIR}/euroc_mav_params.txt"
...
for BAG_FILE in "${BAG_FILES[@]}"; do
    ...
    POSE_DIR="${RESULT_ROOT}/pose/euroc_mav/sqrtVINs_Mono/${DATASET}"
    TIME_DIR="${RESULT_ROOT}/time/euroc_mav/sqrtVINs_Mono/${DATASET}"
