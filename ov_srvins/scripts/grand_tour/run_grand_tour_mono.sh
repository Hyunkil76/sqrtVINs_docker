...
PARAM_FILE="${SCRIPT_DIR}/grand_tour_params.txt"
...
for BAG_FILE in "${BAG_FILES[@]}"; do
    ...
    POSE_DIR="${RESULT_ROOT}/pose/grand_tour/sqrtVINs_Mono/${DATASET}"
    TIME_DIR="${RESULT_ROOT}/time/grand_tour/sqrtVINs_Mono/${DATASET}"
