...
BAG="/dataset/uzhfpv/uzhfpv_outdoor_45"
RESULT_ROOT="/result"

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PARAM_FILE="${SCRIPT_DIR}/uzhfpv_params.txt"
...
for BAG_FILE in "${BAG_FILES[@]}"; do
    ...
    POSE_DIR="${RESULT_ROOT}/pose/uzhfpv/sqrtVINs_Mono/${DATASET}"
    TIME_DIR="${RESULT_ROOT}/time/uzhfpv/sqrtVINs_Mono/${DATASET}"
